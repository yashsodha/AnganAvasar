...
const JanoiScreen: FC = () => {

    const dispatch = useDispatch();
    const janoiMember = useSelector(state => state?.SecureAccountReducer?.JanoiData)
